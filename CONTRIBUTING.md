# Contributing to ansible-truenas

Thank you for your interest in contributing to **ansible-truenas**!
...
```bash
git clone https://github.com/stevefulme1/ansible-truenas.git
cd ansible-truenas
```
