...
short_description: Manage Kerberos keytabs
version_added: "1.0.0"
description:
  - Manage Kerberos keytabs on a TrueNAS system via the middleware API.
options:
  name:
...
- name: Manage manage kerberos keytabs
  stevefulme1.storage.kerberos_keytab:
...
RETURN = r"""
kerberos_keytab:
  description: The manage kerberos keytabs details.
  returned: success
  type: dict
"""
